...
def frame():#初始界面
    ...
    lable1 = tk.Label(root, text='Please choose the user type:',font=('思源黑体', 30)).place(x=80, y=500)#下
    tk.Button(root, text='Reader', font=('思源黑体', 20), width=10, height=2, command=exit_reader).place(x=350, y=420)
    tk.Button(root, text='Administrator', font=('思源黑体', 20), width=10, height=2, command=exit_manager).place(x=350, y=550)
